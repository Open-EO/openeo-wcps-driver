...
public class ServicesApiServiceImpl extends ServicesApiService {
    ...
    @Override
    public Response servicesServiceIdOptions(String serviceId, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response servicesServiceIdPatch(String serviceId, Service2 service, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
}
