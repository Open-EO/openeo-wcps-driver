...
//			return Response.ok().entity(mapper.writeValueAsString(job)).build();
	...
	@Override
	public Response jobsPreviewOptions(SecurityContext securityContext) throws NotFoundException {
		return Response.ok().build();
	}

	@Override
	public Response jobsPreviewPost(JobFull job, SecurityContext securityContext) throws NotFoundException {
		JSONObject processGraphJSON;
		String outputFormat = "JSON";
