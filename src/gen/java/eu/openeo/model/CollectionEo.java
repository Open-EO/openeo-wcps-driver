...
import eu.openeo.model.STACEOBand;
...
public class CollectionEo  implements Serializable {
  ...
  private List<STACEOBand> eoColonBands = new ArrayList<STACEOBand>();
  ...
  public CollectionEo eoColonBands(List<STACEOBand> eoColonBands) {
    this.eoColonBands = eoColonBands;
    return this;
  }

  public CollectionEo addEoColonBandsItem(STACEOBand eoColonBandsItem) {
  ...
  @NotNull @Valid 
  public List<STACEOBand> getEoColonBands() {
    return eoColonBands;
  }

  public void setEoColonBands(List<STACEOBand> eoColonBands) {
    this.eoColonBands = eoColonBands;
  }
