...
/**
 * Process graph to be executed as callback from withing the process.
 */
@ApiModel(description = "Process graph to be executed as callback from withing the process.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJerseyServerCodegen", date = "2019-07-22T13:33:50.326+02:00[Europe/Rome]")
public class Callback  implements Serializable {
  @JsonProperty("callback")
  private Map<String, ProcessNode> callback = new HashMap<String, ProcessNode>();

  public Callback callback(Map<String, ProcessNode> callback) {
    this.callback = callback;
    return this;
  }

  public Callback putCallbackItem(String key, ProcessNode callbackItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.callback, callback.callback);
  }
