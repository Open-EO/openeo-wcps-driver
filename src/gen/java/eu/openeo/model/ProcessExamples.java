...
public class ProcessExamples  implements Serializable {
  @JsonProperty("title")
  ...
  private Map<String, ProcessArgumentValue> arguments = null;

  @JsonProperty("returns")
  private Object returns = null;

  public ProcessExamples title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ProcessExamples description(String description) {
  ...
  public ProcessExamples processGraph(Map<String, ProcessNode> processGraph) {
    this.processGraph = processGraph;
    return this;
  }

  public ProcessExamples putProcessGraphItem(String key, ProcessNode processGraphItem) {
  ...
  public ProcessExamples arguments(Map<String, ProcessArgumentValue> arguments) {
    this.arguments = arguments;
    return this;
  }

  public ProcessExamples putArgumentsItem(String key, ProcessArgumentValue argumentsItem) {
    if (this.arguments == null) {
      this.arguments = new HashMap<String, ProcessArgumentValue>();
    }
  ...
  public ProcessExamples returns(Object returns) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProcessExamples processExamples = (ProcessExamples) o;
    return Objects.equals(this.title, processExamples.title) &&
        Objects.equals(this.description, processExamples.description) &&
        Objects.equals(this.processGraph, processExamples.processGraph) &&
        Objects.equals(this.arguments, processExamples.arguments) &&
        Objects.equals(this.returns, processExamples.returns);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, processGraph, arguments, returns);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessExamples {\n");
