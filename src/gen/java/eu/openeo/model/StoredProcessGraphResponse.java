...
public class StoredProcessGraphResponse  implements Serializable {
  ...
  public StoredProcessGraphResponse processGraph(Map<String, ProcessNode> processGraph) {
    this.processGraph = processGraph;
    return this;
  }

  public StoredProcessGraphResponse putProcessGraphItem(String key, ProcessNode processGraphItem) {
  ...
  public String toString() {
    ...
    sb.append("class StoredProcessGraphResponse {\n");
