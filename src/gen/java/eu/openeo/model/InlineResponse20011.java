...
import eu.openeo.model.InlineResponse20011Jobs;
...
public class InlineResponse20011  implements Serializable {
  @JsonProperty("jobs")
  private List<InlineResponse20011Jobs> jobs = new ArrayList<InlineResponse20011Jobs>();

  @JsonProperty("links")
  private List<Link> links = new ArrayList<Link>();

  public InlineResponse20011 jobs(List<InlineResponse20011Jobs> jobs) {
    this.jobs = jobs;
    return this;
  }

  public InlineResponse20011 addJobsItem(InlineResponse20011Jobs jobsItem) {
  ...
  @ApiModelProperty(required = true, value = "Array of job descriptions")
    @NotNull
@Valid
  public List<InlineResponse20011Jobs> getJobs() {
    return jobs;
  }

  public void setJobs(List<InlineResponse20011Jobs> jobs) {
    this.jobs = jobs;
  }

  public InlineResponse20011 links(List<Link> links) {
    this.links = links;
    return this;
  }

  public InlineResponse20011 addLinksItem(Link linksItem) {
...
@Valid
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.jobs, inlineResponse20011.jobs) &&
        Objects.equals(this.links, inlineResponse20011.links);
  }
