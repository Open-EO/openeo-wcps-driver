...
public class WorkspaceFilesListResponse  implements Serializable {
  @JsonProperty("files")
  ...
  public WorkspaceFilesListResponse files(List<File> files) {
    this.files = files;
    return this;
  }

  public WorkspaceFilesListResponse addFilesItem(File filesItem) {
