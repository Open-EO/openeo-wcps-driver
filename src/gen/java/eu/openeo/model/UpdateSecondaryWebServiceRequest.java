...
public class UpdateSecondaryWebServiceRequest  implements Serializable {
  @JsonProperty("title")
  ...
  public UpdateSecondaryWebServiceRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public UpdateSecondaryWebServiceRequest description(String description) {
  ...
  public UpdateSecondaryWebServiceRequest processGraph(Map<String, ProcessNode> processGraph) {
    this.processGraph = processGraph;
    return this;
  }

  public UpdateSecondaryWebServiceRequest putProcessGraphItem(String key, ProcessNode processGraphItem) {
  ...
  public UpdateSecondaryWebServiceRequest enabled(Boolean enabled) {
  ...
  public UpdateSecondaryWebServiceRequest parameters(Object parameters) {
   ...
   **/
  @JsonProperty("parameters")
  @ApiModelProperty(example = "{\"version\":\"1.3.0\"}", value = "List of arguments, i.e. the parameter names supported by the secondary web service combined with actual values. See `GET /service_types` for supported parameters and valid arguments. For example, this could specify the required version of the service, visualization details or any other service dependant configuration.")
  @Valid 
  ...
  public UpdateSecondaryWebServiceRequest plan(String plan) {
    this.plan = plan;
    return this;
  }
  ...
  public UpdateSecondaryWebServiceRequest budget(BigDecimal budget) {
    this.budget = budget;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateSecondaryWebServiceRequest updateSecondaryWebServiceRequest = (UpdateSecondaryWebServiceRequest) o;
    return Objects.equals(this.title, updateSecondaryWebServiceRequest.title) &&
        Objects.equals(this.description, updateSecondaryWebServiceRequest.description) &&
        Objects.equals(this.processGraph, updateSecondaryWebServiceRequest.processGraph) &&
        Objects.equals(this.enabled, updateSecondaryWebServiceRequest.enabled) &&
        Objects.equals(this.parameters, updateSecondaryWebServiceRequest.parameters) &&
        Objects.equals(this.plan, updateSecondaryWebServiceRequest.plan) &&
        Objects.equals(this.budget, updateSecondaryWebServiceRequest.budget);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, processGraph, enabled, parameters, plan, budget);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSecondaryWebServiceRequest {\n");
