...
public class Process implements Serializable {
	...
	private static final long serialVersionUID = 881453878038282956L;
	 ...
	 * support named parameters. This property MUST be present for all processes
	...
	/**
	 * A list of parameters that are applicable for this process. The keys of the
	 * object are the names of the parameters. They keys MUST match the following
	 * pattern: &#x60;^[A-Za-z0-9_]+$&#x60;
	 * 
	 * @return parameters
	 **/
	 ...
	 * process. MUST be used only for exceptions that stop the execution of a
	 * process and are therefore not to be used for warnings, or notices or
	 * debugging messages. The keys define the error code and MUST match the
	 * following pattern: &#x60;^[A-Za-z0-9_]+$&#x60; This schema follows the schema
	 * of the general openEO error list (see errors.json).
	 * 
	 * @return exceptions
	 **/
	@JsonProperty("exceptions")
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, summary, description, categories, parameterOrder, parameters, returns, deprecated,
				experimental, exceptions, examples, links);
	}
