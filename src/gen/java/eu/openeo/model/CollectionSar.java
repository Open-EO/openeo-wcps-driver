...
public class CollectionSar  implements Serializable {
  ...
  public enum SarColonFrequencyBandEnum {
    ...
    @JsonCreator
    public static SarColonFrequencyBandEnum fromValue(String text) {
  ...
  public enum SarColonPolarizationEnum {
    ...
    @JsonCreator
    public static SarColonPolarizationEnum fromValue(String text) {
  ...
  private List<Object> sarColonBands = null;
  ...
  @JsonProperty("sar:absolute_orbit")
  private List<Object> sarColonAbsoluteOrbit = null;
 ...
 @Size(min=1,max=4)
  ...
  public CollectionSar sarColonBands(List<Object> sarColonBands) {
    this.sarColonBands = sarColonBands;
    return this;
  }

  public CollectionSar addSarColonBandsItem(Object sarColonBandsItem) {
    if (this.sarColonBands == null) {
      this.sarColonBands = new ArrayList<Object>();
    }
  ...
  public List<Object> getSarColonBands() {
    return sarColonBands;
  }

  public void setSarColonBands(List<Object> sarColonBands) {
    this.sarColonBands = sarColonBands;
  }
  ...
  public CollectionSar sarColonAbsoluteOrbit(List<Object> sarColonAbsoluteOrbit) {
    this.sarColonAbsoluteOrbit = sarColonAbsoluteOrbit;
    return this;
  }

  public CollectionSar addSarColonAbsoluteOrbitItem(Object sarColonAbsoluteOrbitItem) {
    if (this.sarColonAbsoluteOrbit == null) {
      this.sarColonAbsoluteOrbit = new ArrayList<Object>();
    }
    this.sarColonAbsoluteOrbit.add(sarColonAbsoluteOrbitItem);
    return this;
  }

  /**
   * A list of absolute orbit numbers. Usually corresponds to the orbit count within the orbit cycle (e.g. ALOS, ERS-1/2, JERS-1, and RADARSAT-1, Sentinel-1). For UAVSAR it is the [Flight ID](http://uavsar.jpl.nasa.gov/cgi-bin/data.pl). A range can be specified as two element array in the array, e.g. &#x60;[25101, [25131, 25140]]&#x60; would be 25101 and 25131 to 25140.
   * @return sarColonAbsoluteOrbit
   **/
  @JsonProperty("sar:absolute_orbit")
  @ApiModelProperty(value = "A list of absolute orbit numbers. Usually corresponds to the orbit count within the orbit cycle (e.g. ALOS, ERS-1/2, JERS-1, and RADARSAT-1, Sentinel-1). For UAVSAR it is the [Flight ID](http://uavsar.jpl.nasa.gov/cgi-bin/data.pl). A range can be specified as two element array in the array, e.g. `[25101, [25131, 25140]]` would be 25101 and 25131 to 25140.")
   @Size(min=1)
  public List<Object> getSarColonAbsoluteOrbit() {
    return sarColonAbsoluteOrbit;
  }

  public void setSarColonAbsoluteOrbit(List<Object> sarColonAbsoluteOrbit) {
    this.sarColonAbsoluteOrbit = sarColonAbsoluteOrbit;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sarColonPlatform, collectionSar.sarColonPlatform) &&
        ...
        Objects.equals(this.sarColonAbsoluteOrbit, collectionSar.sarColonAbsoluteOrbit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sarColonPlatform, sarColonConstellation, sarColonInstrument, sarColonInstrumentMode, sarColonFrequencyBand, sarColonCenterWavelength, sarColonCenterFrequency, sarColonPolarization, sarColonBands, sarColonType, sarColonResolution, sarColonPixelSpacing, sarColonLooks, sarColonAbsoluteOrbit);
  }
  ...
  public String toString() {
    ...
    sb.append("    sarColonAbsoluteOrbit: ").append(toIndentedString(sarColonAbsoluteOrbit)).append("\n");
    sb.append("}");
    return sb.toString();
  }
