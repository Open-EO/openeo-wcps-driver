...
public class ServicesApi  {
   ...
   public ServicesApi(@Context ServletConfig servletContext) {
    ...
    public Response servicesOptions(@Context SecurityContext securityContext)
...
,@Context SecurityContext securityContext)
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
    public Response servicesServiceIdDelete(@ApiParam(value = "Service identifier string",required=true) @PathParam("service_id") String serviceId
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
    public Response servicesServiceIdGet(@ApiParam(value = "Service identifier string",required=true) @PathParam("service_id") String serviceId
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 405, message = "The requested HTTP method is not supported or allowed to be requested.", response = Void.class) })
    public Response servicesServiceIdOptions(@ApiParam(value = "Service identifier string",required=true) @PathParam("service_id") String serviceId
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
    public Response servicesServiceIdPatch(@ApiParam(value = "Service identifier string",required=true) @PathParam("service_id") String serviceId
