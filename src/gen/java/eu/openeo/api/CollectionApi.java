...
public class CollectionApi {
	...
	public Response collectionGet(
		...
		return delegate.collectionGet(qname, qgeom, qstartdate, qenddate, securityContext);
	}
	...
	@io.swagger.annotations.ApiResponses(value = {
			...
			@io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
	public Response coveragesGet(
			@ApiParam(value = "string expression to search available datasets by name") @QueryParam("qname") String qname,
			@ApiParam(value = "WKT polygon to search for available datasets that spatially intersect with the polygon") @QueryParam("qgeom") String qgeom,
			@ApiParam(value = "ISO 8601 date/time string to find datasets with any data acquired after the given date/time") @QueryParam("qstartdate") String qstartdate,
			@ApiParam(value = "ISO 8601 date/time string to find datasets with any data acquired before the given date/time") @QueryParam("qenddate") String qenddate,
			@Context SecurityContext securityContext) throws NotFoundException {
		return delegate.coveragesGet(qname, qgeom, qstartdate, qenddate, securityContext);
	}

	@GET
	@Path("/collections/opensearch")
	@Consumes({ "application/json" })
	...
	@io.swagger.annotations.ApiResponses(value = {
			...
			@io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
	public Response collectionOpensearchGet(
			...
			@Context SecurityContext securityContext) throws NotFoundException {
		return delegate.collectionOpensearchGet(q, start, rows, securityContext);
	}
	...
	public Response collectionOpensearchOptions(@Context SecurityContext securityContext) throws NotFoundException {
		return delegate.collectionOpensearchOptions(securityContext);
	}
	...
	@io.swagger.annotations.ApiResponses(value = {
			...
			@io.swagger.annotations.ApiResponse(code = 405, message = "The requested HTTP method is not supported or allowed to be requested.", response = Void.class) })
	public Response collectionOptions(@Context SecurityContext securityContext) throws NotFoundException {
		return delegate.collectionOptions(securityContext);
	}
	...
	@io.swagger.annotations.ApiResponses(value = {
			...
			@io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
	public Response collectionProductIdGet(
			@ApiParam(value = "product identifier string such as `MOD18Q1`", required = true) @PathParam("collection_id") String productId,
			@Context SecurityContext securityContext) throws NotFoundException {
		return delegate.collectionProductIdGet(productId, securityContext);
	}
	...
	public Response dataProductIdOptions(
			@ApiParam(value = "product identifier string such as `MOD18Q1`", required = true) @PathParam("collection_id") String productId,
			@Context SecurityContext securityContext) throws NotFoundException {
		return delegate.collectionProductIdOptions(productId, securityContext);
	}
	
	@GET
	@Path("/collections/{collection_id}/coverages")
	@Consumes({ "application/json" })
	@Produces({ "application/json" })
	@io.swagger.annotations.ApiOperation(value = "Returns further information on a given EO product available at the back-end.", notes = "The request will ask the back-end for further details about a product specified by the identifier `name`", response = InlineResponse2002.class, authorizations = {
			@io.swagger.annotations.Authorization(value = "Bearer") }, tags = { "EO Data Discovery", })
	@io.swagger.annotations.ApiResponses(value = {
			...
			@io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
	public Response collectionProductIdCoveragesGet(
			@ApiParam(value = "product identifier string such as `MOD18Q1`", required = true) @PathParam("collection_id") String productId,
			@Context SecurityContext securityContext) throws NotFoundException {
		return delegate.collectionProductIdCoveragesGet(productId, securityContext);
	}
	
	@GET
	@Path("/collections/{collection_id}/coverages/{coverage_id}")
	@Consumes({ "application/json" })
	@Produces({ "application/json" })
	@io.swagger.annotations.ApiOperation(value = "Returns further information on a given EO product available at the back-end.", notes = "The request will ask the back-end for further details about a product specified by the identifier `name`", response = InlineResponse2002.class, authorizations = {
			@io.swagger.annotations.Authorization(value = "Bearer") }, tags = { "EO Data Discovery", })
	@io.swagger.annotations.ApiResponses(value = {
			...
			@io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
	public Response collectionProductIdCoveragesCoverageIdGet(
			@ApiParam(value = "collection identifier string such as `Sentinel-2`", required = true) @PathParam("collection_id") String productId,
			@ApiParam(value = "coverage identifier string such as `openEO_S2_32632_20m_L2A`", required = true) @PathParam("coverage_id") String coverageId,
			@Context SecurityContext securityContext) throws NotFoundException {
		return delegate.collectionProductIdCoveragesCoverageIdGet(productId, coverageId, securityContext);
	}
