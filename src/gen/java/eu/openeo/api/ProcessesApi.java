...
,@Context SecurityContext securityContext)
    ...
    public Response processesOpensearchOptions(@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 405, message = "The requested HTTP method is not supported or allowed to be requested.", response = Void.class) })
    public Response processesOptions(@Context SecurityContext securityContext)
    throws NotFoundException {
...
,@Context SecurityContext securityContext)
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 405, message = "The requested HTTP method is not supported or allowed to be requested.", response = Void.class) })
    public Response processesProcessIdOptions(@ApiParam(value = "process identifier string such as `NDVI`",required=true) @PathParam("process_id") String processId
,@Context SecurityContext securityContext)
    throws NotFoundException {
