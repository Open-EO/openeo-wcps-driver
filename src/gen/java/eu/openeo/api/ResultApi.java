...
import eu.openeo.model.InlineObject1;
...
public class ResultApi  {
   ...
   public ResultApi(@Context ServletConfig servletContext) {
    ...
    public Response resultPost(@ApiParam(value = "" ) @Valid InlineObject1 inlineObject1
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.resultPost(inlineObject1,securityContext);
    }
}
