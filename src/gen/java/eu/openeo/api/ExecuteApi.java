...
public class ExecuteApi  {
   ...
   public ExecuteApi(@Context ServletConfig servletContext) {
    ...
    public Response executeOptions(@Context SecurityContext securityContext)
    ...
    }, tags={ "Result Access","Job Management", })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response executePost(@ApiParam(value = "Specifies the job details, e.g. the process graph and the output format." ,required=true) Job job
