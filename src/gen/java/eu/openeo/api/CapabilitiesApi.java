...
public class CapabilitiesApi  {
   ...
   public CapabilitiesApi(@Context ServletConfig servletContext) {
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Returns output formats supported by the back-end.", notes = "The request will ask the back-end for supported output formats, e.g. PNG, GTiff and time series, and its default output format. The response is an object of the default and all available output formats and their options. This does not include the supported web services. **Note**: Whenever available, the output format names and options should be fully aligned with GDAL, see http://www.gdal.org/formats_list.html. Some file formats not available through GDAL might be defined centrally for openEO in the documentation. Custom output formats ot options can be defined wherever needed. Not all output format options supported by GDAL need to be supported.", response = InlineResponse200.class, tags={ "Capabilities", })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response capabilitiesOutputFormatsGet(@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Returns web service types supported by the back-end.", notes = "The request will ask the back-end for supported web service types, e.g. wms, tms, wmts or wcs. The response is an array of available web services types.", response = String.class, responseContainer = "List", tags={ "Capabilities","Services", })
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
    public Response capabilitiesServicesGet(@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 405, message = "The requested HTTP method is not supported or allowed to be requested.", response = Void.class) })
    public Response capabilitiesServicesOptions(@Context SecurityContext securityContext)
    throws NotFoundException {
