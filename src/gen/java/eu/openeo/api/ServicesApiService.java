...
public abstract class ServicesApiService {
    ...
    public abstract Response servicesServiceIdOptions(String serviceId,SecurityContext securityContext) throws NotFoundException;
    public abstract Response servicesServiceIdPatch(String serviceId,Service2 service,SecurityContext securityContext) throws NotFoundException;
}
