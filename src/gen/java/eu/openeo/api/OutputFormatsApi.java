...
public class OutputFormatsApi  {
   ...
   public OutputFormatsApi(@Context ServletConfig servletContext) {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "An object with containing all output format names as keys and an object that defines supported paramaters.", response = Map.class, responseContainer = "Map"),
