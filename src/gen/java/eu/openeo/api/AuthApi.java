...
public class AuthApi  {
   ...
   public AuthApi(@Context ServletConfig servletContext) {
    ...
    public Response authLoginOptions(@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 405, message = "The requested HTTP method is not supported or allowed to be requested.", response = Void.class) })
    public Response authRegisterOptions(@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Registers a new user account.", notes = "***Work in progress.** The general authentication procedure is to be defined and will probably change in the future.* This request registers a new user account.", response = String.class, tags={ "Authentication", })
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
    public Response authRegisterPost(@ApiParam(value = "Password to be used for the newly created user account." ,required=true) String password
