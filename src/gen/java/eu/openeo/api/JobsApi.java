...
public class JobsApi  {
   ...
   public JobsApi(@Context ServletConfig servletContext) {
    ...
    public Response jobsJobIdCancelOptions(@ApiParam(value = "Job identifier string",required=true) @PathParam("job_id") String jobId
,@Context SecurityContext securityContext)
    ...
    public Response jobsJobIdCancelPatch(@ApiParam(value = "Job identifier string",required=true) @PathParam("job_id") String jobId
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
    public Response jobsJobIdDownloadGet(@ApiParam(value = "Job identifier string",required=true) @PathParam("job_id") String jobId
...
,@Context SecurityContext securityContext)
    ...
    public Response jobsJobIdDownloadOptions(@ApiParam(value = "Job identifier string",required=true) @PathParam("job_id") String jobId
,@ApiParam(value = "Output format to be used. Supported formats and options can be retrieved using the `GET /capabilities/output_formats` endpoint. If no output format has been specified here or for the job in general, the back-end falls back to its default format, which is  specified in the `GET /capabilities/output_formats` endpoint. **Note:** The options available to the specified output format can be added as individual query parameters to the request.") @QueryParam("format") String format
,@Context SecurityContext securityContext)
    throws NotFoundException {
...
,@Context SecurityContext securityContext)
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 405, message = "The requested HTTP method is not supported or allowed to be requested.", response = Void.class) })
    public Response jobsJobIdOptions(@ApiParam(value = "Job identifier string",required=true) @PathParam("job_id") String jobId
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
    public Response jobsJobIdPatch(@ApiParam(value = "Job identifier string",required=true) @PathParam("job_id") String jobId
,@ApiParam(value = "Specifies the job details to update, e.g. the process graph or the output format." ) Job job
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 405, message = "The requested HTTP method is not supported or allowed to be requested.", response = Void.class) })
    public Response jobsJobIdPauseOptions(@ApiParam(value = "Job identifier string",required=true) @PathParam("job_id") String jobId
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
    public Response jobsJobIdPausePatch(@ApiParam(value = "Job identifier string",required=true) @PathParam("job_id") String jobId
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 406, message = "The server is not capable to deliver the requested format.", response = Void.class) })
    public Response jobsJobIdQueueOptions(@ApiParam(value = "Job identifier string",required=true) @PathParam("job_id") String jobId
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
    public Response jobsJobIdQueuePatch(@ApiParam(value = "Job identifier string",required=true) @PathParam("job_id") String jobId
,@Context SecurityContext securityContext)
    throws NotFoundException {
...
,@Context SecurityContext securityContext)
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 405, message = "The requested HTTP method is not supported or allowed to be requested.", response = Void.class) })
    public Response jobsJobIdSubscribeOptions(@ApiParam(value = "Job identifier string",required=true) @PathParam("job_id") String jobId
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 405, message = "The requested HTTP method is not supported or allowed to be requested.", response = Void.class) })
    public Response jobsOptions(@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "The service is currently unavailable.", response = Void.class) })
    public Response jobsPost(@ApiParam(value = "Specifies the job details, e.g. the process graph and _optionally_ the output format. The output format might be also specified later during download and is not necessary for web services at all." ) String job
,@Context SecurityContext securityContext)
    throws NotFoundException {
