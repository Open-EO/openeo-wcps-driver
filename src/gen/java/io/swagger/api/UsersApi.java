...
,@Context SecurityContext securityContext)
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "List user-uploaded files", notes = "This service lists all user-uploaded files that are stored at the back-end", response = InlineResponse2004.class, responseContainer = "List", tags={ "User Content", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Flattened file tree with path relative to the user's root directory and some basic properties such as file size.", response = InlineResponse2004.class, responseContainer = "List"),
...
,@Context SecurityContext securityContext)
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "File with specified path is not available", response = Void.class),
