...
import io.swagger.model.ArgSet;
...
public class ProcessGraph   {
  ...
  public ProcessGraph args(List<ArgSet> args) {
    this.args = args;
    return this;
  }

  public ProcessGraph addArgsItem(ArgSet argsItem) {
    if (this.args == null) {
      this.args = new ArrayList<ArgSet>();
    }
  ...
  /**
   * Collection of arguments identified by their name.
   * @return args
   **/
  @JsonProperty("args")
  @ApiModelProperty(value = "Collection of arguments identified by their name.")
  public List<ArgSet> getArgs() {
    return args;
  }

  public void setArgs(List<ArgSet> args) {
    this.args = args;
  }
