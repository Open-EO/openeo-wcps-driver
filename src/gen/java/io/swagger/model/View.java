...
import io.swagger.model.ViewSpace;
import io.swagger.model.ViewTime;
import javax.validation.constraints.*;

/**
 * The view defines how we look at the data (spatial extent, resolution, time range, etc.) for processing. It can be used to experiment with tasks and processes on small subdataset.
 */
@ApiModel(description = "The view defines how we look at the data (spatial extent, resolution, time range, etc.) for processing. It can be used to experiment with tasks and processes on small subdataset.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaJerseyServerCodegen", date = "2018-01-16T14:36:16.100+01:00")
public class View   {
  @JsonProperty("space")
  private ViewSpace space = null;

  @JsonProperty("time")
  private ViewTime time = null;

  public View space(ViewSpace space) {
    this.space = space;
    return this;
  }
  ...
  public ViewSpace getSpace() {
    return space;
  }

  public void setSpace(ViewSpace space) {
    this.space = space;
  }

  public View time(ViewTime time) {
    this.time = time;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    View view = (View) o;
    return Objects.equals(this.space, view.space) &&
        Objects.equals(this.time, view.time);
  }
